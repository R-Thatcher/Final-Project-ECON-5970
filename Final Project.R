...
#Make some histograms for both Twitter and non-Twitter Economists to see differences in h.index and years active
hist(econ.twitter$h.index,
     main = "Histogram of Twitter Economists: h index",
     xlab = "h index",
     border = "black",
     col = "#3BB9FF",
     xlim = c(0, 100))

hist(econ.twitter$years.active,
     main = "Histogram of Twitter Economists: Years Active",
     xlab = "Years Active",
     border = "black",
     col = "#3BB9FF",
     xlim = c(0, 60))

hist(non.twitter$h.index,
     main = "Histogram of Non-Twitter Economists: h index",
     xlab = "h index",
     border = "black",
     col = "#438D80",
     xlim = c(0, 100))

hist(non.twitter$years.active,
     main = "Histogram of Non-Twitter Economists: Years Active",
     xlab = "Years Active",
     border = "black",
     col = "#438D80",
     xlim = c(0, 60))
