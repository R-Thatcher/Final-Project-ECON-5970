...
#Create a loop that will collect the data from the citation cite - the h.index, i10.index, and number of citations, and they year they published their first paper (so the years they have been an active economist)
